<?php
class Logeecom_Laraconnect_Block_Adminhtml_Packagemanager_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    protected function _construct()
    {
        $this->_blockGroup = 'logeecom_laraconnect_adminhtml';
        $this->_controller = 'packagemanager';
         ...
         * to Laraconnect/Block/Adminhtml/Packagemanager/Edit/.
         */
        $this->_mode = 'edit';
