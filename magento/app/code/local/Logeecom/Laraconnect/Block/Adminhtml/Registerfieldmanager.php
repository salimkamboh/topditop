<?php
class Logeecom_Laraconnect_Block_Adminhtml_Registerfieldmanager
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected function _construct()
    {
         ...
         */
        $this->_controller = 'registerfieldmanager';

        /**
         * The title of the page in the admin registerfield.
         */
        $this->_headerText = Mage::helper('logeecom_laraconnect')->__('Registerfield Management');
