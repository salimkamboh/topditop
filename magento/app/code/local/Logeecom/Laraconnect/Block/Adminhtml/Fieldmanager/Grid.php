...
class Logeecom_Laraconnect_Block_Adminhtml_Fieldmanager_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _prepareCollection()
    {
        ...
        $collection = $this->_getHelper()->getRestCollection($lara_url . $lang . "/api/fields/all");
    ...
    public function getRowUrl($row)
    {
         ...
         * FieldmanagerController.php in FieldmanagerDirectory module.
         */
        return $this->getUrl(
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array(
                        'base' => 'logeecom_laraconnect_admin' . '/fieldmanager/edit',
                    ),
                    'field' => 'id'
                ),
            ),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('fieldmanager');
