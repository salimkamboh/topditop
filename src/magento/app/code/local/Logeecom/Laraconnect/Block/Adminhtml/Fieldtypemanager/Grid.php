...
class Logeecom_Laraconnect_Block_Adminhtml_Fieldtypemanager_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _prepareCollection()
    {
        $lara_url = $this->_getHelper()->getLaraUrl();
        $collection = $this->_getHelper()->getRestCollection($lara_url . "api/fieldtypes/all");
    ...
    public function getRowUrl($row)
    {
         ...
         * FieldtypemanagerController.php in FieldtypemanagerDirectory module.
         */
        return $this->getUrl(
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array(
                        'base' => 'logeecom_laraconnect_admin' . '/fieldtypemanager/edit',
                    ),
                    'field' => 'id'
                ),
            ),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('fieldtypemanager');
