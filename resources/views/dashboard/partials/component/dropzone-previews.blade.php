...
<div id="preview-template" style="display: none;">
    ...
    <div class="dz-preview dz-file-preview col-md-6">
        ...
        {{--<div class="reference min-height-360">--}}
            ...
            {{--<a class="dz-remove dz-show" data-dz-remove="">Remove</a>--}}

            {{--<div class="reference__info-wrapper products-manage">--}}
                {{--<div class="reference-add-info text-justify">--}}
                    {{--<a href="#" class="manage-ref margin-b-correct">--}}
                        {{--Replace Scene Image</a>--}}
                    {{--<a class="manage-ref">Delete Scene Image</a>--}}
                {{--</div>--}}
            {{--</div>--}}
