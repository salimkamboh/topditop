<form method="post" action="{{route('references_multi_filter')}}" class="filter-multi">
            ...
            <div class="menu" tabindex="-1">
                @foreach($stores as $store)
                    <div class="item"
                        ...
                        <span>({{$store->getNumberOfReferences()}})</span></div>
                @endforeach
            </div>
        </div>
    </div>
            ...
            <div class="menu" tabindex="-1">
                @foreach($manufacturers as $manufacturer)
                    <div class="item"
                        ...
                        <span>({{$manufacturer->numberOfReferences()}})</span></div>
                @endforeach
            </div>
        </div>
    </div>
