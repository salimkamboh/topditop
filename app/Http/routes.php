...
Route::localizedGroup(function () {
    ...
    Route::group(['prefix' => '/front/'], function () {
        ...
        Route::get('/stores/ad/{advert}/{latitude}/{longitude}', ['as' => 'advert_page', 'uses' => 'FrontController@advertisementShow']);
    ...
    Route::group(['prefix' => '/api/'], function () {
        ...
        Route::group(['prefix' => 'fieldgroups/'], function () {
...
Route::group(['prefix' => 'api/'], function () {
    ...
    Route::group(['prefix' => 'registerfields/'], function () {
