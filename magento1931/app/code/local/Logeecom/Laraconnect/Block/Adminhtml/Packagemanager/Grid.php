...
class Logeecom_Laraconnect_Block_Adminhtml_Packagemanager_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _prepareCollection()
    {
         ...
         */
        $collection = $this->_getHelper()->getRestCollection($lara_url . "api/packages/all");
    ...
    public function getRowUrl($row)
    {
         ...
         * PackagemanagerController.php in PackagemanagerDirectory module.
         */
        return $this->getUrl(
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array(
                        'base' => 'logeecom_laraconnect_admin' . '/packagemanager/edit',
                    ),
                    'field' => 'id'
                ),
            ),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('packagemanager');
