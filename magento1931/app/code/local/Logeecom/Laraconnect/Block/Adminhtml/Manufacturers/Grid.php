...
class Logeecom_Laraconnect_Block_Adminhtml_Manufacturers_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _prepareCollection()
    {
        ...
        $collection = $this->_getHelper()->getRestCollection($lara_url . "api/manufacturers/all");
    ...
    public function getRowUrl($row)
    {
         ...
         * ManufacturersController.php in ManufacturersDirectory module.
         */
        return $this->getUrl(
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array(
                        'base' => 'logeecom_laraconnect_admin' . '/manufacturers/edit',
                    ),
                    'field' => 'id'
                ),
            ),
