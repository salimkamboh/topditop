...
class Logeecom_Laraconnect_Block_Adminhtml_Productmanager_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    protected function _prepareCollection()
    {
        $lara_url = $this->_getHelper()->getLaraUrl();
        $collection = $this->_getHelper()->getRestCollection($lara_url . "api/products");
    ...
    public function getRowUrl($row)
    {
         ...
         * ProductmanagerController.php in ProductmanagerDirectory module.
         */
        return $this->getUrl(
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array(
                        'base' => 'logeecom_laraconnect_admin' . '/productmanager/edit',
                    ),
                    'field' => 'id'
                ),
            ),
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('productmanager');
