<?php
class Logeecom_Laraconnect_Block_Adminhtml_Slidemanager
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected function _construct()
    {
        ...
        /**
         * The title of the page in the admin slide.
         */
        $this->_headerText = Mage::helper('logeecom_laraconnect')->__('Slide Management');
