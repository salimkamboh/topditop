<?php
class Logeecom_Laraconnect_Block_Adminhtml_Categorymanager
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected function _construct()
    {
        ...
        /**
         * The title of the page in the admin category.
         */
        $this->_headerText = Mage::helper('logeecom_laraconnect')->__('Category Management');
