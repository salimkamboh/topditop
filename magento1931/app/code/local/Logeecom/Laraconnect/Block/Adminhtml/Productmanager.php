<?php
class Logeecom_Laraconnect_Block_Adminhtml_Productmanager
    extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected function _construct()
    {
         ...
         */
        $this->_controller = 'productmanager';

        /**
         * The title of the page in the admin product.
         */
        $this->_headerText = Mage::helper('logeecom_laraconnect')->__('Product Management');
